    ...
    return (
        <div className={`relative ${size} ${rotation} ${className} [container-type:inline-size]`}>
            ...
            {(isCurrentActive || isShowingGhost) && (
                ...
                >
                    <div
                        className={`aspect-[4/5] p-[6%] pb-[22%] relative overflow-hidden bg-charcoal/[0.03] border border-charcoal/5 opacity-40`}
                        style={{ borderRadius: '2px' }}
                    >
                        <div className="w-full h-[84%] relative overflow-hidden bg-charcoal/[0.05]" />
                    </div>
                </div>
            )}
...
export { VARIANTS, RECIPES, CHAMPION_SHADOW, textures };
export type { Variant };
